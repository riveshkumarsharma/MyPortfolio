    ...
    >
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400 mt-4 text-lg font-semibold">
          A set of tools and technologies I work with to create seamless and
          high-quality web experiences.
        </p>
      </div>
      {/* skills list  */}
      <div
        className="bg-gray-900 backdrop-blur-md px-6 sm:px-10 py-8 sm:py-6 mb-10 w-full rounded-2xl 
